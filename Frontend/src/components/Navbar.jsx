                ...
                <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <nav className='flex items-center justify-between py-3'>
                        ...
                        <div className='hidden md:flex items-center gap-6'>
                            ...
                            <a onClick={() => navigate("/login")} className='text-sm neon-btn bg-purple-500 hover:bg-purple-700 px-3 py-2 rounded-lg text-white'>Login</a>
                        </div>
                        {/* Mobile menu button */}
                    ...
                    {open && (
                        <div className="md:hidden mt-2 mb-4 bg-slate-900/70 glass rounded-lg p-4">
                            ...
                            <div className="mt-3 flex items-center gap-2">
                                ...
                                <a href="#login" className="px-3 py-2 neon-btn rounded-lg bg-indigo-600 text-white">Login</a>
                            </div>
                        </div>
                    )}
                </div>
